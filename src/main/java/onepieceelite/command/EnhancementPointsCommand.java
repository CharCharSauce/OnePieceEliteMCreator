...
package onepieceelite.command;

import onepieceelite.procedures.EnhancementPointsCommandExecutedProcedure;
...
public class EnhancementPointsCommand extends OnePieceEliteModElements.ModElement {
	...
	private LiteralArgumentBuilder<CommandSource> customCommand() {
		return LiteralArgumentBuilder.<CommandSource>literal("enhancementpoints")
