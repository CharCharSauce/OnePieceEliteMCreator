...
public class OnePieceEliteModVariables {
	public OnePieceEliteModVariables(OnePieceEliteModElements elements) {
	...
	public void onAttachCapabilities(AttachCapabilitiesEvent<Entity> event) {
		if (event.getObject() instanceof PlayerEntity && !(event.getObject() instanceof FakePlayer))
			event.addCapability(new ResourceLocation("one_piece_elite", "player_variables"), new PlayerVariablesProvider());
	}
