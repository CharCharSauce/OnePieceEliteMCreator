...
public class RareShardItem extends OnePieceEliteModElements.ModElement {
	@ObjectHolder("one_piece_elite:rare_shard")
	public static final Item block = null;
	public RareShardItem(OnePieceEliteModElements instance) {
		super(instance, 3);
	}
