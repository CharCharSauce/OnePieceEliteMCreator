...
public class EpicShardItem extends OnePieceEliteModElements.ModElement {
	@ObjectHolder("one_piece_elite:epic_shard")
	public static final Item block = null;
	public EpicShardItem(OnePieceEliteModElements instance) {
		super(instance, 2);
	}
